========================================================================
    ACTIVE TEMPLATE LIBRARY : ComCalculator Project Overview
========================================================================

AppWizard has created this ComCalculator project for you to use as the starting point for
writing your Dynamic Link Library (DLL).

This file contains a summary of what you will find in each of the files that
make up your project.

ComCalculator.vcxproj
    This is the main project file for VC++ projects generated using an Application Wizard.
    It contains information about the version of Visual C++ that generated the file, and
    information about the platforms, configurations, and project features selected with the
    Application Wizard.

ComCalculator.vcxproj.filters
...
ComCalculator.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (ComCalculator.h)
        GUID definitions                                (ComCalculator_i.c)
        A type library                                  (ComCalculator.tlb)
        Marshaling code                                 (ComCalculator_p.c and dlldata.c)

ComCalculator.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in ComCalculator.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named ComCalculator.pch and a precompiled types file named StdAfx.obj.
...
ComCalculatorps.vcxproj
	...
	dlldata.c, ComCalculator_i.c and ComCalculator_p.c which are required
	to build the proxy/stub DLL.

ComCalculatorps.vcxproj.filters
